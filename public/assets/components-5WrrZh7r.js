...
`,qe=a=>{const t=new Uint8Array(a);let i="";for(const s of t)i+=String.fromCharCode(s);return btoa(i).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")},lt=a=>{for(a=a.replace(/-/g,"+").replace(/_/g,"/");a.length%4;)a+="=";const t=atob(a),i=new Uint8Array(t.length);for(let s=0;s<t.length;s++)i[s]=t.charCodeAt(s);return i};function ja({children:a,className:t="",style:i={},onClick:s}){return e.jsx("div",{className:`wallet-bento-tile ${t}`,onClick:s,style:{background:"#0f0f0f",border:"1px solid #222",borderRadius:12,padding:16,position:"relative",cursor:s?"pointer":"default",transition:"border-color 0.2s, box-shadow 0.2s",display:"flex",flexDirection:"column",...i},onMouseEnter:o=>{o.currentTarget.style.borderColor="#333",o.currentTarget.style.boxShadow="0 0 20px rgba(0,212,255,0.1)"},onMouseLeave:o=>{o.currentTarget.style.borderColor="#222",o.currentTarget.style.boxShadow="none"},children:a})}function wa({children:a,color:t="#555"}){return e.jsx("div",{style:{fontSize:10,fontWeight:700,color:t,textTransform:"uppercase",letterSpacing:1,marginBottom:12},children:a})}const sn={major:{label:"Major Networks",chains:["solana","ethereum","polygon","base","bsc"]},layer2:{label:"Layer 2",chains:["arbitrum","optimism","zksync","linea","scroll","mantle"]},other:{label:"Other Networks",chains:["avalanche","fantom","cronos","gnosis","celo","moonbeam","moonriver","harmony","metis","aurora","kava","evmos"]}},ct=["Your portfolio is looking great!","Ready to make moves?","Stay vigilant, stay profitable!","DeFi awaits your next play.","Diversification is key!","HODL strong, trade smart.","The market never sleeps!"],We={mnemonic:{term:"Recovery Phrase",definition:"A 12 or 24 word phrase that backs up your wallet. Anyone with these words can access your funds. Never share it!"},privateKey:{term:"Private Key",definition:"A secret code that proves ownership of your wallet. Keep it safe and never share it with anyone."},gasEstimate:{term:"Gas Fee",definition:"A small fee paid to process your transaction on the blockchain. Varies by network congestion."},hdWallet:{term:"HD Wallet",definition:"One recovery phrase creates addresses on multiple blockchains. All your crypto in one place."}},he={solana:{name:"Solana",symbol:"SOL",color:"#9945FF",gradient:"linear-gradient(135deg, #9945FF, #14F195)",icon:"◎"},ethereum:{name:"Ethereum",symbol:"ETH",color:"#627EEA",gradient:"linear-gradient(135deg, #627EEA, #454A75)",icon:"Ξ"},polygon:{name:"Polygon",symbol:"MATIC",color:"#8247E5",gradient:"linear-gradient(135deg, #8247E5, #A46EFF)",icon:"⬡"},base:{name:"Base",symbol:"ETH",color:"#0052FF",gradient:"linear-gradient(135deg, #0052FF, #3B7AFF)",icon:"⬡"},arbitrum:{name:"Arbitrum",symbol:"ETH",color:"#28A0F0",gradient:"linear-gradient(135deg, #28A0F0, #1B6CB0)",icon:"⬡"},bsc:{name:"BSC",symbol:"BNB",color:"#F3BA2F",gradient:"linear-gradient(135deg, #F3BA2F, #E8A914)",icon:"⬡"},avalanche:{name:"Avalanche",symbol:"AVAX",color:"#E84142",gradient:"linear-gradient(135deg, #E84142, #C73032)",icon:"⬡"},fantom:{name:"Fantom",symbol:"FTM",color:"#1969FF",gradient:"linear-gradient(135deg, #1969FF, #0D4FC5)",icon:"⬡"},optimism:{name:"Optimism",symbol:"ETH",color:"#FF0420",gradient:"linear-gradient(135deg, #FF0420, #CC031A)",icon:"⬡"},cronos:{name:"Cronos",symbol:"CRO",color:"#002D74",gradient:"linear-gradient(135deg, #002D74, #001A45)",icon:"⬡"},gnosis:{name:"Gnosis",symbol:"xDAI",color:"#04795B",gradient:"linear-gradient(135deg, #04795B, #035F47)",icon:"⬡"},celo:{name:"Celo",symbol:"CELO",color:"#35D07F",gradient:"linear-gradient(135deg, #35D07F, #28A865)",icon:"⬡"},moonbeam:{name:"Moonbeam",symbol:"GLMR",color:"#53CBC8",gradient:"linear-gradient(135deg, #53CBC8, #3FA3A1)",icon:"⬡"},moonriver:{name:"Moonriver",symbol:"MOVR",color:"#F2B705",gradient:"linear-gradient(135deg, #F2B705, #C99504)",icon:"⬡"},harmony:{name:"Harmony",symbol:"ONE",color:"#00AEE9",gradient:"linear-gradient(135deg, #00AEE9, #0090C1)",icon:"⬡"},metis:{name:"Metis",symbol:"METIS",color:"#00D2FF",gradient:"linear-gradient(135deg, #00D2FF, #00A8CC)",icon:"⬡"},aurora:{name:"Aurora",symbol:"ETH",color:"#70D44B",gradient:"linear-gradient(135deg, #70D44B, #59B03C)",icon:"⬡"},zksync:{name:"zkSync",symbol:"ETH",color:"#4E529A",gradient:"linear-gradient(135deg, #4E529A, #3D417A)",icon:"⬡"},linea:{name:"Linea",symbol:"ETH",color:"#121212",gradient:"linear-gradient(135deg, #61DFFF, #4BB8D6)",icon:"⬡"},scroll:{name:"Scroll",symbol:"ETH",color:"#FFEEDA",gradient:"linear-gradient(135deg, #FFEEDA, #E8D4C0)",icon:"⬡"},mantle:{name:"Mantle",symbol:"MNT",color:"#000000",gradient:"linear-gradient(135deg, #65B3AE, #4E908C)",icon:"⬡"},kava:{name:"Kava",symbol:"KAVA",color:"#FF564F",gradient:"linear-gradient(135deg, #FF564F, #E84842)",icon:"⬡"},evmos:{name:"Evmos",symbol:"EVMOS",color:"#ED4E33",gradient:"linear-gradient(135deg, #ED4E33, #C94229)",icon:"⬡"}};function rn({userId:a}){const t=xt(),[i,s]=n.useState("landing"),[o,p]=n.useState(""),[h,x]=n.useState(""),[u,c]=n.useState(""),[j,g]=n.useState(""),[y,F]=n.useState(""),[m,v]=n.useState(""),[f,D]=n.useState(""),[L,X]=n.useState(!1),[O,E]=n.useState(""),[b,H]=n.useState("solana"),[I,Z]=n.useState(""),[Y,se]=n.useState(""),[U,le]=n.useState(""),[te,ne]=n.useState(null),[de,w]=n.useState(!1),[z,q]=n.useState(null),[Q,R]=n.useState(!1),[B,G]=n.useState("major"),[$,k]=n.useState(!1),[P,J]=n.useState(""),[d,l]=n.useState(""),[C,W]=n.useState(!1),[_,K]=n.useState(!1),[re,me]=n.useState(!1),[ie,Ta]=n.useState("solana"),[Aa,Xe]=n.useState("sol"),[Qe,za]=n.useState(""),[Ba,Ze]=n.useState(!1),[Da,Ne]=n.useState(""),[Cn,Ra]=n.useState(null),[mt,Pa]=n.useState(!1),[Wa,Ea]=n.useState([]),[pe,La]=n.useState({address:"So11111111111111111111111111111111111111112",symbol:"SOL",name:"Solana",decimals:9,logoURI:null}),[xe,Ia]=n.useState(null),[we,ea]=n.useState(""),[ze,Le]=n.useState("50"),[ce,Te]=n.useState(null),[Ie,aa]=n.useState(!1),[Ma,ta]=n.useState(!1),[Me,na]=n.useState(""),[_a,fe]=n.useState(""),[$a,sa]=n.useState(""),[ra,ia]=n.useState(""),[oa,la]=n.useState(""),[Oa,_e]=n.useState(!1),[Ua,$e]=n.useState(!1),[ca,ft]=n.useState(!1),[Va,da]=n.useState(!1);n.useEffect(()=>{bt()},[a]);const bt=async()=>{try{const r=localStorage.getItem("sessionToken");if(!r)return;const N=await fetch("/api/webauthn/has-credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sessionToken:r,usedFor:"wallet"})});if(N.ok){const M=await N.json();ft(M.hasCredentials)}}catch(r){console.error("Failed to check biometric wallet status:",r)}},yt=async()=>{const r=localStorage.getItem("sessionToken");if(!r)throw new Error("No session");const N=await fetch("/api/webauthn/authentication/start",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sessionToken:r,usedFor:"wallet"})});if(!N.ok){const ge=await N.json();throw new Error(ge.error||"Failed to start biometric verification")}const{challengeId:M,options:oe}=await N.json(),Se={...oe,challenge:lt(oe.challenge),allowCredentials:oe.allowCredentials.map(ge=>({...ge,id:lt(ge.id)}))},ee=await navigator.credentials.get({publicKey:Se}),ue=await fetch("/api/webauthn/authentication/verify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sessionToken:r,challengeId:M,credential:{id:ee.id,rawId:qe(ee.rawId),type:ee.type,response:{clientDataJSON:qe(ee.response.clientDataJSON),authenticatorData:qe(ee.response.authenticatorData),signature:qe(ee.response.signature)}},usedFor:"wallet"})});if(!ue.ok){const ge=await ue.json();throw new Error(ge.error||"Biometric verification failed")}return!0};n.useEffect(()=>{t.hasWallet&&(t.isUnlocked?s("main"):s("unlock"))},[t.hasWallet,t.isUnlocked]);const ke=()=>{x(""),c("")},vt=async()=>{if(ke(),!y||y.length<8){x("Password must be at least 8 characters");return}if(y!==m){x("Passwords do not match");return}try{const r=O.trim()||`Wallet ${t.wallets.length+1}`,N=await t.createWallet(y,r,12);p(N),X(!0),s("backup"),E(""),c("Wallet created! Save your recovery phrase now.")}catch(r){x(r.message)}},jt=async()=>{if(ke(),!j.trim()){x("Please enter your recovery phrase");return}if(!y||y.length<8){x("Password must be at least 8 characters");return}if(y!==m){x("Passwords do not match");return}try{const r=O.trim()||`Imported Wallet ${t.wallets.length+1}`;await t.importWallet(j.trim(),y,r),s("main"),E(""),c("Wallet imported successfully!")}catch(r){x(r.message)}},Ha=async()=>{ke();try{await t.unlock(f),s("main")}catch(r){x(r.message||"Invalid password")}},wt=async()=>{if(!I||!Y||!t.addresses)return;const r=t.addresses[b];if(r)try{const M=await(await fetch("/api/wallet/estimate-gas",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chain:b,from:r,to:I,amount:Y})})).json();M.success&&ne(M)}catch(N){console.error("Gas estimate error:",N)}};n.useEffect(()=>{if(I&&Y&&parseFloat(Y)>0){const r=setTimeout(wt,500);return()=>clearTimeout(r)}},[I,Y,b]);const kt=async()=>{if(ke(),!I||!Y||!U){x("Please fill in all fields including password");return}try{if(ca){da(!0);try{await yt()}catch(N){da(!1),x("Biometric verification failed: "+N.message);return}da(!1)}const r=await t.signAndSend(U,b,I,Y);if(!r.success)throw new Error(r.error);c(`Transaction sent! Hash: ${r.txHash?.slice(0,20)}...`),Z(""),se(""),le(""),ne(null),w(!1)}catch(r){x(r.message)}},St=()=>{t.lock(),D(""),s("unlock")},Ft=()=>{confirm("Are you sure? This will remove your wallet from this device. Make sure you have your recovery phrase saved!")&&(t.activeWalletId&&t.deleteWallet(t.activeWalletId),t.hasWallet||s("landing"))},qa=async()=>{if(ke(),!P){x("Please enter your password");return}K(!0);try{const r=await Za.unlock(P,t.activeWalletId);l(r.mnemonic),W(!1),x("")}catch{x("Invalid password. Please try again.")}finally{K(!1)}},pa=()=>{k(!1),J(""),l(""),W(!1),x("")},Ct=async()=>{Ze(!0),Ne("");try{const r=ie==="solana"?t.addresses?.solana:t.addresses?.ethereum;if(!r){Ne("Wallet address not available");return}const N=await fetch("/api/crypto/onramp/create-session",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({walletAddress:r,network:ie,currency:Aa,amount:Qe?parseFloat(Qe):void 0})}),M=await N.json();if(!N.ok){M.needsSetup?Ne("Stripe Crypto Onramp is not enabled. To enable it, visit your Stripe Dashboard and apply for access to the Crypto Onramp feature."):Ne(M.error||"Failed to create onramp session");return}M.redirectUrl?(window.open(M.redirectUrl,"_blank"),xa()):M.clientSecret&&Ra(M)}catch(r){Ne(r.message||"Failed to connect to onramp service")}finally{Ze(!1)}},xa=()=>{me(!1),Ta("solana"),Xe("sol"),za(""),Ne(""),Ze(!1),Ra(null)},Nt=async()=>{try{const N=await(await fetch("/api/swap/tokens")).json();N.success&&N.tokens&&Ea(N.tokens)}catch(r){console.error("Failed to fetch swap tokens:",r)}},Tt=async()=>{if(!pe||!xe||!we||parseFloat(we)<=0){Te(null);return}aa(!0),fe("");try{const r=Math.floor(parseFloat(we)*Math.pow(10,pe.decimals)).toString(),N=new URLSearchParams({inputMint:pe.address,outputMint:xe.address,amount:r,slippageBps:ze}),oe=await(await fetch(`/api/swap/quote?${N}`)).json();oe.success?Te(oe):(fe(oe.error||"Failed to get quote"),Te(null))}catch(r){fe(r.message||"Failed to get quote"),Te(null)}finally{aa(!1)}},At=async()=>{if(!ce||!Me){fe("Please enter your password");return}if(!ce?.quoteResponse){fe("Quote data is missing. Please get a new quote.");return}if(!t?.addresses?.solana){fe("Wallet not ready. Please unlock your wallet first.");return}ta(!0),fe(""),sa("");try{const N=await(await fetch("/api/swap/prepare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({quoteResponse:ce.quoteResponse,userPublicKey:t.addresses.solana})})).json();if(!N.success)throw new Error(N.error||"Failed to prepare swap");const M=await Za.signSolanaTransaction(Me,N.swapTransaction,t.activeWalletId),Se=await(await fetch("/api/swap/broadcast",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({signedTransaction:M})})).json();if(Se.success)sa(`Swap successful! View on explorer: ${Se.explorerUrl}`),Te(null),ea(""),na("");else throw new Error(Se.error||"Failed to broadcast transaction")}catch(r){fe(r.message||"Swap failed")}finally{ta(!1)}},Ga=()=>{Pa(!1),Ea([]),La({address:"So11111111111111111111111111111111111111112",symbol:"SOL",name:"Solana",decimals:9,logoURI:null}),Ia(null),ea(""),Le("50"),Te(null),aa(!1),ta(!1),na(""),fe(""),sa(""),ia(""),la(""),_e(!1),$e(!1)};n.useEffect(()=>{if(pe&&xe&&we&&parseFloat(we)>0){const r=setTimeout(Tt,500);return()=>clearTimeout(r)}},[pe,xe,we,ze]);const ga=r=>{navigator.clipboard.writeText(r),c("Address copied!"),setTimeout(()=>c(""),2e3)},zt=r=>{H(r),w(!0)},Bt=()=>e.jsxs("div",{className:"wallet-landing-v2",children:[e.jsxs("div",{className:"wallet-hero",children:[e.jsx("div",{className:"wallet-hero-icon",children:e.jsxs("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"walletGrad",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#00D4FF"}),e.jsx("stop",{offset:"100%",stopColor:"#0099FF"})]})}),e.jsx("rect",{x:"2",y:"6",width:"20",height:"14",rx:"3",stroke:"url(#walletGrad)",strokeWidth:"2"}),e.jsx("path",{d:"M22 10h-4a2 2 0 100 4h4",stroke:"url(#walletGrad)",strokeWidth:"2"}),e.jsx("circle",{cx:"18",cy:"12",r:"1.5",fill:"#00D4FF"})]})}),e.jsx("h1",{children:"Multi-Chain Wallet"}),e.jsxs("p",{children:["One seed phrase. All your crypto.",e.jsx(Pe,{definition:We.hdWallet})]})]}),e.jsx("div",{className:"wallet-chains-showcase",children:Object.entries(he).map(([r,N],M)=>e.jsxs("div",{className:"wallet-chain-card",style:{"--chain-color":N.color,"--chain-gradient":N.gradient,animationDelay:`${M*.1}s`},children:[e.jsx("span",{className:"chain-icon",children:N.icon}),e.jsx("span",{className:"chain-name",children:N.name})]},r))}),e.jsxs("div",{className:"wallet-features",children:[e.jsxs("div",{className:"wallet-feature",children:[e.jsx("span",{className:"feature-icon",children:"🔐"}),e.jsx("span",{children:"Client-side encryption"})]}),e.jsxs("div",{className:"wallet-feature",children:[e.jsx("span",{className:"feature-icon",children:"⚡"}),e.jsx("span",{children:"Instant transactions"})]}),e.jsxs("div",{className:"wallet-feature",children:[e.jsx("span",{className:"feature-icon",children:"🛡️"}),e.jsx("span",{children:"Non-custodial"})]})]}),e.jsxs("div",{className:"wallet-cta-group",children:[e.jsxs("button",{className:"wallet-cta primary",onClick:()=>s("create"),children:[e.jsx("span",{className:"cta-icon",children:"+"}),"Create New Wallet"]}),e.jsxs("button",{className:"wallet-cta secondary",onClick:()=>s("import"),children:[e.jsx("span",{className:"cta-icon",children:"↓"}),"Import Existing"]})]})]}),Dt=()=>e.jsxs("div",{className:"wallet-form-v2",children:[e.jsx("button",{className:"wallet-back-btn",onClick:()=>{s("landing"),ke()},children:"← Back"}),e.jsxs("div",{className:"form-header",children:[e.jsx("div",{className:"form-icon create",children:e.jsxs("svg",{width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"#00D4FF",strokeWidth:"2",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 8v8M8 12h8"})]})}),e.jsx("h2",{children:"Create Your Wallet"}),e.jsx("p",{children:"Set a strong password to protect your wallet"})]}),e.jsxs("div",{className:"form-fields",children:[e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Wallet Name (optional)"}),e.jsx("input",{type:"text",value:O,onChange:r=>E(r.target.value),placeholder:"My Trading Wallet"}),e.jsx("span",{className:"field-hint",children:"Give your wallet a memorable name"})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Password"}),e.jsx("input",{type:"password",value:y,onChange:r=>F(r.target.value),placeholder:"Minimum 8 characters"}),e.jsx("span",{className:"field-hint",children:"Used to encrypt your wallet locally"})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Confirm Password"}),e.jsx("input",{type:"password",value:m,onChange:r=>v(r.target.value),placeholder:"Re-enter password"})]})]}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:vt,disabled:t.loading,children:t.loading?"Creating...":"Create Wallet"})]}),Rt=()=>e.jsxs("div",{className:"wallet-form-v2",children:[e.jsxs("div",{className:"form-header warning",children:[e.jsx("div",{className:"form-icon warning",children:e.jsxs("svg",{width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"#FF6B6B",strokeWidth:"2",children:[e.jsx("path",{d:"M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"}),e.jsx("line",{x1:"12",y1:"9",x2:"12",y2:"13"}),e.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]})}),e.jsx("h2",{children:"Save Your Recovery Phrase"}),e.jsxs("p",{className:"warning-text",children:["Write these words down in order. This is the ONLY way to recover your wallet!",e.jsx(Pe,{definition:We.mnemonic})]})]}),e.jsx("div",{className:"mnemonic-grid",children:o?.split(" ").map((r,N)=>e.jsxs("div",{className:"mnemonic-word",children:[e.jsx("span",{className:"word-num",children:N+1}),e.jsx("span",{className:"word-text",children:L?r:"•••••"})]},N))}),e.jsx("button",{className:"wallet-cta secondary full-width",onClick:()=>X(!L),children:L?"🙈 Hide Words":"👁️ Reveal Words"}),u&&e.jsx("div",{className:"form-success",children:u}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:()=>{p(""),s("main")},children:"I've Saved My Phrase ✓"})]}),Pt=()=>e.jsxs("div",{className:"wallet-form-v2",children:[e.jsx("button",{className:"wallet-back-btn",onClick:()=>{s("landing"),ke()},children:"← Back"}),e.jsxs("div",{className:"form-header",children:[e.jsx("div",{className:"form-icon import",children:e.jsxs("svg",{width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"#00D4FF",strokeWidth:"2",children:[e.jsx("path",{d:"M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"}),e.jsx("polyline",{points:"7,10 12,15 17,10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]})}),e.jsx("h2",{children:"Import Wallet"}),e.jsx("p",{children:"Enter your 12 or 24 word recovery phrase"})]}),e.jsxs("div",{className:"form-fields",children:[e.jsxs("div",{className:"form-field",children:[e.jsxs("label",{children:["Recovery Phrase",e.jsx(Pe,{definition:We.mnemonic})]}),e.jsx("textarea",{value:j,onChange:r=>g(r.target.value),placeholder:"word1 word2 word3 ...",rows:3})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Wallet Name (optional)"}),e.jsx("input",{type:"text",value:O,onChange:r=>E(r.target.value),placeholder:"Imported Wallet"})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"New Password"}),e.jsx("input",{type:"password",value:y,onChange:r=>F(r.target.value),placeholder:"Minimum 8 characters"})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Confirm Password"}),e.jsx("input",{type:"password",value:m,onChange:r=>v(r.target.value),placeholder:"Re-enter password"})]})]}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:jt,disabled:t.loading,children:t.loading?"Importing...":"Import Wallet"})]}),Wt=()=>e.jsxs("div",{className:"wallet-form-v2 unlock",children:[e.jsxs("div",{className:"unlock-icon",children:[e.jsx("div",{className:"lock-glow"}),e.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"#00D4FF",strokeWidth:"1.5",children:[e.jsx("rect",{x:"3",y:"11",width:"18",height:"11",rx:"2"}),e.jsx("path",{d:"M7 11V7a5 5 0 0110 0v4"})]})]}),e.jsx("h2",{children:"Welcome Back"}),e.jsx("p",{children:"Enter your password to unlock"}),e.jsx("div",{className:"form-field single",children:e.jsx("input",{type:"password",value:f,onChange:r=>D(r.target.value),placeholder:"Enter password",onKeyDown:r=>r.key==="Enter"&&Ha(),autoFocus:!0})}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:Ha,disabled:t.loading,children:t.loading?"Unlocking...":"Unlock Wallet"}),e.jsx("button",{className:"wallet-link",onClick:Ft,children:"Remove wallet from this device"})]}),[ua,Be]=n.useState(!1),[Et,Oe]=n.useState(null),[ha,De]=n.useState(""),[Ue,ma]=n.useState(null),[fa,ba]=n.useState(""),Ka=async()=>{if(!(!Ue||!fa))try{await t.switchWallet(Ue,fa),ma(null),ba(""),c("Wallet switched!")}catch(r){x(r.message||"Failed to switch wallet")}},Ya=r=>{ha.trim()&&(t.renameWallet(r,ha.trim()),Oe(null),De(""),c("Wallet renamed!"))},Lt=r=>{const N=t.wallets.find(M=>M.id===r);confirm(`Delete wallet "${N?.name}"? Make sure you have your recovery phrase saved!`)&&(t.deleteWallet(r),Be(!1))},It=t.wallets.find(r=>r.id===t.activeWalletId),Mt=n.useMemo(()=>ct[Math.floor(Math.random()*ct.length)],[]);n.useMemo(()=>{if(!t.addresses)return[];const r=Object.entries(t.addresses).filter(([M])=>he[M]),N=[];for(let M=0;M<r.length;M+=2)N.push(r.slice(M,M+2));return N},[t.addresses]);const _t=()=>e.jsxs("div",{className:"wallet-main-v2",children:[e.jsxs("div",{className:"wallet-selector-bar",children:[e.jsxs("div",{className:"wallet-selector",onClick:()=>Be(!ua),children:[e.jsx("span",{className:"wallet-selector-icon",children:"💼"}),e.jsx("span",{className:"wallet-selector-name",children:It?.name||"My Wallet"}),e.jsx("span",{className:"wallet-selector-arrow",children:ua?"▲":"▼"})]}),ua&&e.jsxs("div",{className:"wallet-dropdown",children:[e.jsx("div",{className:"wallet-dropdown-header",children:"Your Wallets"}),t.wallets.map(r=>e.jsx("div",{className:`wallet-dropdown-item ${r.id===t.activeWalletId?"active":""}`,children:Et===r.id?e.jsxs("div",{className:"wallet-rename-inline",children:[e.jsx("input",{type:"text",value:ha,onChange:N=>De(N.target.value),placeholder:r.name,autoFocus:!0,onKeyDown:N=>{N.key==="Enter"&&Ya(r.id),N.key==="Escape"&&(Oe(null),De(""))}}),e.jsx("button",{onClick:()=>Ya(r.id),children:"✓"}),e.jsx("button",{onClick:()=>{Oe(null),De("")},children:"✕"})]}):e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"wallet-item-name",onClick:()=>{r.id!==t.activeWalletId&&(ma(r.id),Be(!1))},children:[r.name,r.id===t.activeWalletId&&e.jsx("span",{className:"active-badge",children:"Active"})]}),e.jsxs("div",{className:"wallet-item-actions",children:[e.jsx("button",{title:"Rename",onClick:N=>{N.stopPropagation(),Oe(r.id),De(r.name)},children:"✏️"}),t.wallets.length>1&&e.jsx("button",{title:"Delete",onClick:N=>{N.stopPropagation(),Lt(r.id)},children:"🗑️"})]})]})},r.id)),e.jsx("div",{className:"wallet-dropdown-divider"}),e.jsxs("button",{className:"wallet-dropdown-add",onClick:()=>{Be(!1),s("create")},children:[e.jsx("span",{children:"+"})," Add New Wallet"]}),e.jsxs("button",{className:"wallet-dropdown-add import",onClick:()=>{Be(!1),s("import")},children:[e.jsx("span",{children:"↓"})," Import Wallet"]})]})]}),Ue&&e.jsx("div",{className:"wallet-switch-modal",children:e.jsxs("div",{className:"wallet-switch-content",children:[e.jsx("h3",{children:"Switch Wallet"}),e.jsxs("p",{children:['Enter password for "',t.wallets.find(r=>r.id===Ue)?.name,'"']}),e.jsx("input",{type:"password",value:fa,onChange:r=>ba(r.target.value),placeholder:"Enter wallet password",autoFocus:!0,onKeyDown:r=>r.key==="Enter"&&Ka()}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsxs("div",{className:"wallet-switch-actions",children:[e.jsx("button",{className:"wallet-cta secondary",onClick:()=>{ma(null),ba(""),x("")},children:"Cancel"}),e.jsx("button",{className:"wallet-cta primary",onClick:Ka,children:"Unlock & Switch"})]})]})}),e.jsxs("div",{className:"wallet-hero-premium",children:[e.jsx("div",{className:"wallet-hero-glow"}),e.jsxs("div",{className:"wallet-hero-content",children:[e.jsxs("div",{className:"wallet-hero-balance",children:[e.jsx("span",{className:"hero-balance-label",children:"Total Balance"}),e.jsxs("span",{className:"hero-balance-value",children:["$",t.totalUsd.toFixed(2)]}),e.jsxs("div",{className:"hero-actions",children:[e.jsx("button",{className:"hero-action-btn",onClick:t.refreshBalances,children:e.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M23 4v6h-6M1 20v-6h6"}),e.jsx("path",{d:"M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"})]})}),e.jsx("button",{className:"hero-action-btn lock",onClick:St,children:e.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("rect",{x:"3",y:"11",width:"18",height:"11",rx:"2"}),e.jsx("path",{d:"M7 11V7a5 5 0 0110 0v4"})]})})]})]}),e.jsxs("div",{className:"wallet-hero-agent",children:[e.jsxs("div",{className:"speech-bubble",children:[e.jsx("span",{children:Mt}),e.jsx("div",{className:"speech-bubble-tail"})]}),e.jsx("img",{src:"/agents/pixar/marcus.png",alt:"Marcus",className:"agent-image"})]})]})]}),u&&e.jsx("div",{className:"form-success",children:u}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsxs("div",{className:"wallet-bento-grid",children:[e.jsxs(ja,{className:"chains-tile",style:{gridColumn:"span 8"},children:[e.jsx(wa,{color:"#00D4FF",children:"Your Networks"}),e.jsx("div",{className:"chain-accordion",children:Object.entries(sn).map(([r,N])=>{const M=B===r,oe=N.chains.filter(ee=>t.addresses?.[ee]),Se=oe.reduce((ee,ue)=>ee+(t.balances[ue]?.usd||0),0);return e.jsxs("div",{className:"chain-category",children:[e.jsxs("div",{className:`chain-category-header ${M?"expanded":""}`,onClick:()=>G(M?null:r),children:[e.jsxs("div",{className:"category-info",children:[e.jsx("span",{className:"category-label",children:N.label}),e.jsxs("span",{className:"category-count",children:[oe.length," networks"]})]}),e.jsxs("div",{className:"category-right",children:[e.jsxs("span",{className:"category-total",children:["$",Se.toFixed(2)]}),e.jsx("span",{className:"category-arrow",children:M?"▲":"▼"})]})]}),M&&e.jsxs("div",{className:"chain-category-content",children:[oe.map(ee=>{const ue=he[ee],ge=t.addresses[ee],Ve=t.balances[ee],ya=z===ee;return e.jsxs("div",{className:`chain-accordion-item ${ya?"expanded":""}`,style:{"--chain-color":ue.color},children:[e.jsxs("div",{className:"chain-item-header",onClick:()=>q(ya?null:ee),children:[e.jsxs("div",{className:"chain-item-left",children:[e.jsx("span",{className:"chain-icon",style:{color:ue.color},children:ue.icon}),e.jsx("span",{className:"chain-name",children:ue.name})]}),e.jsxs("div",{className:"chain-item-right",children:[e.jsxs("span",{className:"chain-balance",children:[Ve?Ve.balance:"0"," ",ue.symbol]}),e.jsxs("span",{className:"chain-usd",children:["$",Ve?Ve.usd.toFixed(2):"0.00"]})]})]}),ya&&e.jsxs("div",{className:"chain-item-details",children:[e.jsxs("div",{className:"chain-address",onClick:Re=>{Re.stopPropagation(),ga(ge)},children:[e.jsxs("span",{children:[ge?.slice(0,12),"...",ge?.slice(-8)]}),e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2"}),e.jsx("path",{d:"M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"})]})]}),e.jsxs("div",{className:"chain-item-actions",children:[e.jsxs("button",{onClick:Re=>{Re.stopPropagation(),zt(ee)},children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("line",{x1:"22",y1:"2",x2:"11",y2:"13"}),e.jsx("polygon",{points:"22,2 15,22 11,13 2,9"})]}),"Send"]}),e.jsxs("button",{onClick:Re=>{Re.stopPropagation(),ga(ge)},children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"}),e.jsx("polyline",{points:"7,10 12,15 17,10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),"Receive"]})]})]})]},ee)}),oe.length===0&&e.jsx("div",{className:"no-chains-message",children:"No wallets in this category"})]})]},r)})})]}),e.jsxs(ja,{className:"quick-actions-tile",style:{gridColumn:"span 4"},children:[e.jsx(wa,{color:"#00D4FF",children:"Quick Actions"}),e.jsxs("div",{className:"quick-actions-bento",children:[e.jsxs("button",{className:"quick-action-btn",onClick:()=>{H("solana"),w(!0)},children:[e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("line",{x1:"22",y1:"2",x2:"11",y2:"13"}),e.jsx("polygon",{points:"22,2 15,22 11,13 2,9"})]}),e.jsx("span",{children:"Send"})]}),e.jsxs("button",{className:"quick-action-btn",onClick:()=>t.addresses?.solana&&ga(t.addresses.solana),children:[e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"}),e.jsx("polyline",{points:"7,10 12,15 17,10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),e.jsx("span",{children:"Receive"})]}),e.jsxs("button",{className:"quick-action-btn swap",onClick:()=>{Pa(!0),Nt()},children:[e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M16 3l4 4-4 4"}),e.jsx("path",{d:"M20 7H4"}),e.jsx("path",{d:"M8 21l-4-4 4-4"}),e.jsx("path",{d:"M4 17h16"})]}),e.jsx("span",{children:"Swap"})]}),e.jsxs("button",{className:"quick-action-btn buy",onClick:()=>me(!0),children:[e.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("path",{d:"M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"})}),e.jsx("span",{children:"Buy"})]}),t.addresses?.solana&&e.jsxs("button",{className:"quick-action-btn dust",onClick:()=>R(!0),children:[e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M3 6h18M3 6l2 14h14l2-14M3 6l4-4h10l4 4"}),e.jsx("path",{d:"M9 10v6M12 10v6M15 10v6"})]}),e.jsx("span",{children:"Dust Buster"})]}),e.jsxs("button",{className:"quick-action-btn backup",onClick:()=>k(!0),children:[e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M12 15V3M12 3l-4 4M12 3l4 4"}),e.jsx("path",{d:"M2 17l.621 2.485A2 2 0 004.561 21h14.878a2 2 0 001.94-1.515L22 17"})]}),e.jsx("span",{children:"Backup"})]})]})]}),e.jsxs(ja,{className:"multisig-tile",style:{gridColumn:"span 12"},children:[e.jsx(wa,{color:"#9945FF",children:"Multi-Sig Wallets"}),e.jsxs("div",{className:"multisig-placeholder",children:[e.jsx("div",{className:"multisig-icon",children:e.jsxs("svg",{width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",stroke:"#9945FF",strokeWidth:"1.5",children:[e.jsx("path",{d:"M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"}),e.jsx("circle",{cx:"9",cy:"7",r:"4"}),e.jsx("path",{d:"M23 21v-2a4 4 0 00-3-3.87"}),e.jsx("path",{d:"M16 3.13a4 4 0 010 7.75"})]})}),e.jsxs("div",{className:"multisig-info",children:[e.jsx("h4",{children:"Team Vaults & Multi-Signature Wallets"}),e.jsx("p",{children:"Create secure multi-sig wallets that require multiple approvals for transactions. Perfect for teams, DAOs, and organizations."}),e.jsx("span",{className:"coming-soon-badge",children:"Coming Soon"})]})]})]})]}),Q&&e.jsx("div",{className:"dust-buster-overlay",onClick:()=>R(!1),children:e.jsxs("div",{className:"dust-buster-panel",onClick:r=>r.stopPropagation(),children:[e.jsxs("div",{className:"dust-buster-header",children:[e.jsx("h3",{children:"Dust Buster"}),e.jsx("button",{className:"close-btn",onClick:()=>R(!1),children:"×"})]}),e.jsx(an,{walletAddress:t.addresses?.solana,onClose:()=>R(!1)})]})}),de&&e.jsx("div",{className:"send-overlay",onClick:()=>w(!1),children:e.jsxs("div",{className:"send-panel",onClick:r=>r.stopPropagation(),children:[e.jsxs("div",{className:"send-header",children:[e.jsxs("h3",{children:["Send ",he[b]?.symbol]}),e.jsx("button",{className:"close-btn",onClick:()=>w(!1),children:"×"})]}),e.jsxs("div",{className:"send-chain-preview",children:[e.jsx("span",{style:{color:he[b]?.color},children:he[b]?.icon}),e.jsx("span",{children:he[b]?.name})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Recipient Address"}),e.jsx("input",{type:"text",value:I,onChange:r=>Z(r.target.value),placeholder:"Enter recipient address"})]}),e.jsxs("div",{className:"form-field",children:[e.jsxs("label",{children:["Amount (",he[b]?.symbol,")"]}),e.jsx("input",{type:"number",value:Y,onChange:r=>se(r.target.value),placeholder:"0.0",step:"0.001"})]}),e.jsxs("div",{className:"form-field",children:[e.jsxs("label",{children:["Wallet Password",e.jsx(Pe,{definition:We.privateKey})]}),e.jsx("input",{type:"password",value:U,onChange:r=>le(r.target.value),placeholder:"Enter password to sign"})]}),te&&e.jsxs("div",{className:"gas-estimate",children:[e.jsxs("span",{children:["Network Fee",e.jsx(Pe,{definition:We.gasEstimate})]}),e.jsxs("span",{children:[te.gasFee," ",he[b]?.symbol]})]}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:kt,disabled:t.loading||Va||!I||!Y||!U,children:Va?"👆 Verify Biometric...":t.loading?"Sending...":ca?"👆 Send with Biometric":"Send Transaction"}),ca&&e.jsx("div",{style:{fontSize:10,color:"#39FF14",textAlign:"center",marginTop:4},children:"Biometric confirmation enabled"})]})}),$&&e.jsx("div",{className:"recovery-overlay",onClick:pa,children:e.jsxs("div",{className:"recovery-panel",onClick:r=>r.stopPropagation(),children:[e.jsxs("div",{className:"recovery-header",children:[e.jsx("h3",{children:"View Recovery Phrase"}),e.jsx("button",{className:"close-btn",onClick:pa,children:"×"})]}),d?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"recovery-warning active",children:[e.jsx("div",{className:"warning-icon",children:e.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"#FF6B6B",strokeWidth:"2",children:[e.jsx("path",{d:"M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"}),e.jsx("line",{x1:"12",y1:"9",x2:"12",y2:"13"}),e.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]})}),e.jsxs("div",{className:"warning-content",children:[e.jsx("strong",{children:"Keep This Secret!"}),e.jsx("p",{children:"Write these words down on paper. Store them in a safe place. Never take a screenshot or save digitally."})]})]}),e.jsx("div",{className:"mnemonic-grid recovery",children:d.split(" ").map((r,N)=>e.jsxs("div",{className:"mnemonic-word",children:[e.jsx("span",{className:"word-num",children:N+1}),e.jsx("span",{className:"word-text",children:C?r:"•••••"})]},N))}),e.jsx("button",{className:"wallet-cta secondary full-width",onClick:()=>W(!C),children:C?"🙈 Hide Words":"👁️ Reveal Words"}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:pa,children:"Done"})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"recovery-warning",children:[e.jsx("div",{className:"warning-icon",children:e.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"#FF6B6B",strokeWidth:"2",children:[e.jsx("path",{d:"M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"}),e.jsx("line",{x1:"12",y1:"9",x2:"12",y2:"13"}),e.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]})}),e.jsxs("div",{className:"warning-content",children:[e.jsx("strong",{children:"Sensitive Information"}),e.jsx("p",{children:"Your recovery phrase grants full access to your wallet. Never share it with anyone or enter it on untrusted websites."})]})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Enter your password to continue"}),e.jsx("input",{type:"password",value:P,onChange:r=>J(r.target.value),placeholder:"Enter wallet password",onKeyDown:r=>r.key==="Enter"&&qa(),autoFocus:!0})]}),h&&e.jsx("div",{className:"form-error",children:h}),e.jsx("button",{className:"wallet-cta primary full-width",onClick:qa,disabled:_||!P,children:_?"Verifying...":"View Recovery Phrase"})]})]})}),re&&e.jsx("div",{className:"buy-overlay",onClick:xa,children:e.jsxs("div",{className:"buy-panel",onClick:r=>r.stopPropagation(),children:[e.jsxs("div",{className:"buy-header",children:[e.jsx("h3",{children:"Buy Crypto"}),e.jsx("button",{className:"close-btn",onClick:xa,children:"×"})]}),e.jsxs("div",{className:"buy-info",children:[e.jsx("div",{className:"buy-info-icon",children:e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 16v-4M12 8h.01"})]})}),e.jsx("span",{children:"Purchase crypto directly with your card via Stripe"})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Network"}),e.jsxs("select",{value:ie,onChange:r=>{Ta(r.target.value),Xe(r.target.value==="solana"?"sol":"eth")},children:[e.jsx("option",{value:"solana",children:"Solana"}),e.jsx("option",{value:"ethereum",children:"Ethereum"}),e.jsx("option",{value:"polygon",children:"Polygon"}),e.jsx("option",{value:"base",children:"Base"}),e.jsx("option",{value:"arbitrum",children:"Arbitrum"})]})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Currency"}),e.jsx("select",{value:Aa,onChange:r=>Xe(r.target.value),children:ie==="solana"?e.jsxs(e.Fragment,{children:[e.jsx("option",{value:"sol",children:"SOL"}),e.jsx("option",{value:"usdc",children:"USDC"})]}):e.jsxs(e.Fragment,{children:[e.jsx("option",{value:"eth",children:"ETH"}),e.jsx("option",{value:"usdc",children:"USDC"})]})})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Amount (USD)"}),e.jsx("input",{type:"number",value:Qe,onChange:r=>za(r.target.value),placeholder:"Enter amount in USD (optional)",min:"1",step:"1"}),e.jsx("span",{className:"field-hint",children:"Leave empty to choose amount on Stripe"})]}),e.jsxs("div",{className:"buy-destination",children:[e.jsx("label",{children:"Destination Wallet"}),e.jsxs("div",{className:"destination-address",children:[e.jsx("span",{className:"destination-network",children:he[ie]?.icon}),e.jsx("span",{className:"destination-addr",children:ie==="solana"?t.addresses?.solana?.slice(0,8)+"..."+t.addresses?.solana?.slice(-6):t.addresses?.ethereum?.slice(0,8)+"..."+t.addresses?.ethereum?.slice(-6)})]})]}),Da&&e.jsxs("div",{className:"form-error buy-error",children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 8v4M12 16h.01"})]}),e.jsx("span",{children:Da})]}),e.jsx("button",{className:"wallet-cta primary full-width stripe-btn",onClick:Ct,disabled:Ba,children:Ba?"Connecting to Stripe...":e.jsxs(e.Fragment,{children:[e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("rect",{x:"1",y:"4",width:"22",height:"16",rx:"2"}),e.jsx("line",{x1:"1",y1:"10",x2:"23",y2:"10"})]}),"Buy with Stripe"]})}),e.jsx("p",{className:"buy-disclaimer",children:"Powered by Stripe. Available for US customers only."})]})}),mt&&e.jsx("div",{className:"swap-overlay",onClick:Ga,children:e.jsxs("div",{className:"swap-panel",onClick:r=>r.stopPropagation(),children:[e.jsxs("div",{className:"swap-header",children:[e.jsx("h3",{children:"Swap Tokens"}),e.jsx("button",{className:"close-btn",onClick:Ga,children:"×"})]}),e.jsxs("div",{className:"swap-info",children:[e.jsx("div",{className:"swap-info-icon",children:e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 16v-4M12 8h.01"})]})}),e.jsx("span",{children:"Swap tokens on Solana via Jupiter"})]}),e.jsxs("div",{className:"swap-token-selector",children:[e.jsx("label",{children:"From"}),e.jsxs("div",{className:"token-select-wrapper",children:[e.jsxs("button",{className:"token-select-btn",onClick:()=>{_e(!Oa),$e(!1)},children:[pe?.logoURI&&e.jsx("img",{src:pe.logoURI,alt:"",className:"token-logo"}),e.jsx("span",{className:"token-symbol",children:pe?.symbol||"Select token"}),e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("polyline",{points:"6,9 12,15 18,9"})})]}),Oa&&e.jsxs("div",{className:"token-dropdown",children:[e.jsx("input",{type:"text",placeholder:"Search tokens...",value:ra,onChange:r=>ia(r.target.value),className:"token-search"}),e.jsx("div",{className:"token-list",children:Wa.filter(r=>r.symbol.toLowerCase().includes(ra.toLowerCase())||r.name.toLowerCase().includes(ra.toLowerCase())).map(r=>e.jsxs("button",{className:`token-option ${pe?.address===r.address?"selected":""}`,onClick:()=>{La(r),_e(!1),ia("")},children:[r.logoURI&&e.jsx("img",{src:r.logoURI,alt:"",className:"token-logo"}),e.jsxs("div",{className:"token-info",children:[e.jsx("span",{className:"token-symbol",children:r.symbol}),e.jsx("span",{className:"token-name",children:r.name})]})]},r.address))})]})]}),e.jsx("input",{type:"number",value:we,onChange:r=>ea(r.target.value),placeholder:"0.0",className:"swap-amount-input"})]}),e.jsx("div",{className:"swap-arrow",children:e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("path",{d:"M12 5v14M5 12l7 7 7-7"})})}),e.jsxs("div",{className:"swap-token-selector",children:[e.jsx("label",{children:"To"}),e.jsxs("div",{className:"token-select-wrapper",children:[e.jsxs("button",{className:"token-select-btn",onClick:()=>{$e(!Ua),_e(!1)},children:[xe?.logoURI&&e.jsx("img",{src:xe.logoURI,alt:"",className:"token-logo"}),e.jsx("span",{className:"token-symbol",children:xe?.symbol||"Select token"}),e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("polyline",{points:"6,9 12,15 18,9"})})]}),Ua&&e.jsxs("div",{className:"token-dropdown",children:[e.jsx("input",{type:"text",placeholder:"Search tokens...",value:oa,onChange:r=>la(r.target.value),className:"token-search"}),e.jsx("div",{className:"token-list",children:Wa.filter(r=>r.symbol.toLowerCase().includes(oa.toLowerCase())||r.name.toLowerCase().includes(oa.toLowerCase())).filter(r=>r.address!==pe?.address).map(r=>e.jsxs("button",{className:`token-option ${xe?.address===r.address?"selected":""}`,onClick:()=>{Ia(r),$e(!1),la("")},children:[r.logoURI&&e.jsx("img",{src:r.logoURI,alt:"",className:"token-logo"}),e.jsxs("div",{className:"token-info",children:[e.jsx("span",{className:"token-symbol",children:r.symbol}),e.jsx("span",{className:"token-name",children:r.name})]})]},r.address))})]})]}),ce&&e.jsxs("div",{className:"swap-output-amount",children:["≈ ",(parseFloat(ce.outputAmount)/Math.pow(10,xe?.decimals||9)).toFixed(6)," ",xe?.symbol]})]}),e.jsxs("div",{className:"swap-slippage",children:[e.jsx("label",{children:"Slippage Tolerance"}),e.jsxs("div",{className:"slippage-options",children:[e.jsx("button",{className:`slippage-btn ${ze==="50"?"active":""}`,onClick:()=>Le("50"),children:"0.5%"}),e.jsx("button",{className:`slippage-btn ${ze==="100"?"active":""}`,onClick:()=>Le("100"),children:"1%"}),e.jsx("button",{className:`slippage-btn ${ze==="300"?"active":""}`,onClick:()=>Le("300"),children:"3%"})]})]}),Ie&&e.jsxs("div",{className:"swap-loading",children:[e.jsx("div",{className:"swap-spinner"}),e.jsx("span",{children:"Fetching best route..."})]}),ce&&!Ie&&e.jsxs("div",{className:"swap-quote-details",children:[e.jsxs("div",{className:"quote-row",children:[e.jsx("span",{children:"Rate"}),e.jsxs("span",{children:["1 ",pe?.symbol," ≈ ",(parseFloat(ce.outputAmount)/parseFloat(ce.inputAmount)).toFixed(6)," ",xe?.symbol]})]}),e.jsxs("div",{className:"quote-row",children:[e.jsx("span",{children:"Price Impact"}),e.jsxs("span",{className:parseFloat(ce.priceImpactPct)>1?"high-impact":"",children:[ce.priceImpactPct,"%"]})]})]}),ce&&!Ie&&e.jsxs("div",{className:"form-field",children:[e.jsx("label",{children:"Wallet Password"}),e.jsx("input",{type:"password",value:Me,onChange:r=>na(r.target.value),placeholder:"Enter password to sign"})]}),_a&&e.jsxs("div",{className:"form-error swap-error",children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 8v4M12 16h.01"})]}),e.jsx("span",{children:_a})]}),$a&&e.jsx("div",{className:"form-success swap-success",children:e.jsx("span",{children:$a})}),e.jsx("button",{className:"wallet-cta primary full-width swap-execute-btn",onClick:At,disabled:!ce||Ie||Ma||!Me,children:Ma?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"swap-spinner small"}),"Swapping..."]}):"Execute Swap"}),e.jsx("p",{className:"swap-disclaimer",children:"Powered by Jupiter. Swaps are executed on Solana."})]})})]});return e.jsxs("div",{className:"wallet-manager-v2",children:[i==="landing"&&Bt(),i==="create"&&Dt(),i==="backup"&&Rt(),i==="import"&&Pt(),i==="unlock"&&Wt(),i==="main"&&_t(),e.jsx("style",{children:`
        .wallet-manager-v2 {
          max-width: 600px;
          margin: 0 auto;
          padding: 24px 16px;
...
4. Wait for approval (1-2 weeks)`}],mn={free:"#00D4FF",pro:"#39FF14",enterprise:"#8B5CF6"},Ee={free:["market:read","signals:read"],pro:["market:read","signals:read","predictions:read","accuracy:read"],enterprise:["market:read","signals:read","predictions:read","accuracy:read","strikeagent:read","webhooks:write"]},ae={background:"rgba(26, 26, 26, 0.6)",backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)"},Fe=({title:a,icon:t,children:i,fullWidth:s,glowColor:o})=>e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"20px",border:`1px solid ${o?`${o}40`:"#2a2a2a"}`,gridColumn:s?"1 / -1":"span 1",boxShadow:o?`0 0 30px ${o}20`:"none",transition:"all 0.3s ease"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px",marginBottom:"16px"},children:[e.jsx("span",{style:{fontSize:"20px"},children:t}),e.jsx("h3",{style:{margin:0,color:"#fff",fontSize:"16px",fontWeight:"600"},children:a})]}),i]}),Ye=({title:a,value:t,subtitle:i,icon:s,glow:o})=>e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"20px",border:`1px solid ${o?`${o}40`:"#2a2a2a"}`,boxShadow:o?`0 0 20px ${o}20`:"none"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"12px"},children:[e.jsx("span",{style:{fontSize:"14px",color:"#888"},children:a}),e.jsx("span",{style:{fontSize:"20px"},children:s})]}),e.jsx("div",{style:{fontSize:"32px",fontWeight:"700",color:"#fff",marginBottom:"4px"},children:t}),i&&e.jsx("div",{style:{fontSize:"12px",color:"#666"},children:i})]}),dt=({count:a})=>e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"24px",border:"1px solid rgba(0, 212, 255, 0.3)",boxShadow:"0 0 40px rgba(0, 212, 255, 0.15)",textAlign:"center"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"12px",marginBottom:"8px"},children:[e.jsx("div",{style:{width:"12px",height:"12px",borderRadius:"50%",background:"#39FF14",boxShadow:"0 0 10px #39FF14",animation:"pulse 2s infinite"}}),e.jsx("span",{style:{fontSize:"14px",color:"#888",textTransform:"uppercase",letterSpacing:"2px"},children:"Live Visitors"})]}),e.jsx("div",{style:{fontSize:"48px",fontWeight:"800",color:"#00D4FF"},children:a}),e.jsx("style",{children:"@keyframes pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.5; } }"})]}),pt=({title:a,items:t,labelKey:i,valueKey:s,icon:o})=>e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"20px",border:"1px solid #2a2a2a"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"16px"},children:[e.jsx("span",{children:o}),e.jsx("span",{style:{fontWeight:"600",color:"#fff"},children:a})]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:t.length===0?e.jsx("div",{style:{color:"#666",fontSize:"13px",textAlign:"center",padding:"20px"},children:"No data yet"}):t.slice(0,5).map((p,h)=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"8px 0",borderBottom:h<Math.min(t.length,5)-1?"1px solid #2a2a2a":"none"},children:[e.jsx("span",{style:{color:"#ccc",fontSize:"13px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:"70%"},children:p[i]}),e.jsx("span",{style:{color:"#00D4FF",fontWeight:"600",fontSize:"13px"},children:p[s]})]},h))})]}),fn=({data:a})=>{const t=[{key:"desktop",label:"Desktop",icon:"🖥️",color:"#00D4FF"},{key:"mobile",label:"Mobile",icon:"📱",color:"#39FF14"},{key:"tablet",label:"Tablet",icon:"📲",color:"#8B5CF6"}];return e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"20px",border:"1px solid #2a2a2a"},children:[e.jsx("div",{style:{fontWeight:"600",color:"#fff",marginBottom:"16px"},children:"Device Breakdown"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:t.map(i=>e.jsxs("div",{children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"4px"},children:[e.jsxs("span",{style:{color:"#888",fontSize:"13px"},children:[i.icon," ",i.label]}),e.jsxs("span",{style:{color:i.color,fontWeight:"600"},children:[a[i.key],"%"]})]}),e.jsx("div",{style:{height:"6px",background:"#2a2a2a",borderRadius:"3px",overflow:"hidden"},children:e.jsx("div",{style:{width:`${a[i.key]}%`,height:"100%",background:i.color,borderRadius:"3px"}})})]},i.key))})]})},bn=({doc:a,onView:t,color:i="#00D4FF"})=>e.jsx("div",{onClick:()=>t(a),style:{...ae,borderRadius:"12px",padding:"16px",border:"1px solid #2a2a2a",cursor:"pointer",transition:"all 0.3s ease",minWidth:"220px",flex:"0 0 auto"},onMouseOver:s=>{s.currentTarget.style.borderColor=i,s.currentTarget.style.transform="translateY(-2px)",s.currentTarget.style.boxShadow=`0 0 25px ${i}30`},onMouseOut:s=>{s.currentTarget.style.borderColor="#2a2a2a",s.currentTarget.style.transform="translateY(0)",s.currentTarget.style.boxShadow="none"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",marginBottom:"8px"},children:[e.jsx("span",{style:{fontSize:"28px"},children:a.icon}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"#fff",fontWeight:"600",fontSize:"14px"},children:a.title}),e.jsx("div",{style:{color:"#666",fontSize:"11px"},children:a.description})]})]})}),yn=({category:a,onViewDoc:t})=>{const i=n.useRef(null),[s,o]=n.useState(!1),[p,h]=n.useState(!0),x=()=>{if(i.current){const{scrollLeft:c,scrollWidth:j,clientWidth:g}=i.current;o(c>0),h(c<j-g-5)}};n.useEffect(()=>{x();const c=i.current;return c&&c.addEventListener("scroll",x),()=>c?.removeEventListener("scroll",x)},[]);const u=c=>{if(i.current){const j=c==="left"?-280:280;i.current.scrollBy({left:j,behavior:"smooth"})}};return e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"20px",border:`1px solid ${a.color}30`,boxShadow:`0 0 30px ${a.color}10`},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"16px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[e.jsx("span",{style:{fontSize:"24px"},children:a.icon}),e.jsx("h3",{style:{margin:0,color:a.color,fontSize:"16px",fontWeight:"600"},children:a.title}),e.jsxs("span",{style:{background:`${a.color}20`,color:a.color,fontSize:"10px",padding:"3px 8px",borderRadius:"8px",fontWeight:"600"},children:[a.docs.length," docs"]})]}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx("button",{onClick:()=>u("left"),disabled:!s,style:{width:"32px",height:"32px",borderRadius:"8px",border:"none",background:s?a.color:"#333",color:s?"#000":"#666",cursor:s?"pointer":"not-allowed",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",transition:"all 0.2s ease"},children:"←"}),e.jsx("button",{onClick:()=>u("right"),disabled:!p,style:{width:"32px",height:"32px",borderRadius:"8px",border:"none",background:p?a.color:"#333",color:p?"#000":"#666",cursor:p?"pointer":"not-allowed",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",transition:"all 0.2s ease"},children:"→"})]})]}),e.jsx("div",{ref:i,style:{display:"flex",gap:"12px",overflowX:"auto",scrollbarWidth:"none",msOverflowStyle:"none",paddingBottom:"4px"},children:a.docs.map(c=>e.jsx(bn,{doc:c,onView:t,color:a.color},c.id))}),e.jsx("style",{children:`
        div::-webkit-scrollbar { display: none; }
      `})]})},vn=({doc:a,onView:t,color:i})=>e.jsxs("div",{onClick:()=>t(a),style:{...ae,borderRadius:"12px",padding:"16px",border:`1px solid ${i}30`,cursor:"pointer",transition:"all 0.3s ease",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",minHeight:"100px"},onMouseOver:s=>{s.currentTarget.style.borderColor=i,s.currentTarget.style.boxShadow=`0 0 30px ${i}30`,s.currentTarget.style.transform="scale(1.02)"},onMouseOut:s=>{s.currentTarget.style.borderColor=`${i}30`,s.currentTarget.style.boxShadow="none",s.currentTarget.style.transform="scale(1)"},children:[e.jsx("span",{style:{fontSize:"32px",marginBottom:"8px"},children:a.icon}),e.jsx("div",{style:{color:"#fff",fontWeight:"600",fontSize:"13px"},children:a.title})]}),jn=({task:a,onToggle:t})=>{const i={high:"#FF4444",medium:"#FFB344",low:"#44FF44"},[s,o]=n.useState(!1);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsxs("div",{onClick:()=>t(a.id),style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px",background:a.done?"rgba(26, 42, 26, 0.6)":"rgba(26, 26, 26, 0.6)",backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",borderRadius:"8px",border:`1px solid ${a.done?"#39FF1430":"#2a2a2a"}`,cursor:"pointer",transition:"all 0.2s ease"},children:[e.jsx("div",{style:{width:"20px",height:"20px",borderRadius:"4px",border:`2px solid ${a.done?"#39FF14":"#444"}`,background:a.done?"#39FF14":"transparent",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0},children:a.done&&e.jsx("span",{style:{color:"#000",fontSize:"12px"},children:"✓"})}),e.jsx("span",{style:{flex:1,color:a.done?"#666":"#fff",textDecoration:a.done?"line-through":"none",fontSize:"14px"},children:a.text}),a.link&&e.jsx("a",{href:a.link,target:"_blank",rel:"noopener noreferrer",onClick:p=>p.stopPropagation(),style:{background:"linear-gradient(135deg, #00D4FF, #0099CC)",color:"#000",padding:"4px 10px",borderRadius:"4px",fontSize:"11px",fontWeight:"600",textDecoration:"none",flexShrink:0},children:"Open →"}),a.instructions&&e.jsx("button",{onClick:p=>{p.stopPropagation(),o(!s)},style:{background:"#333",border:"none",color:"#888",padding:"4px 8px",borderRadius:"4px",fontSize:"11px",cursor:"pointer",flexShrink:0},children:s?"Hide":"Steps"}),e.jsx("div",{style:{width:"8px",height:"8px",borderRadius:"50%",background:i[a.priority],flexShrink:0}})]}),s&&a.instructions&&e.jsx("div",{style:{marginLeft:"32px",padding:"12px",background:"rgba(0, 212, 255, 0.05)",border:"1px solid rgba(0, 212, 255, 0.2)",borderRadius:"8px",fontSize:"12px",color:"#aaa",whiteSpace:"pre-line",lineHeight:"1.6"},children:a.instructions})]})},wn=({doc:a,content:t,onClose:i})=>e.jsxs("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.9)",zIndex:1e4,display:"flex",flexDirection:"column",padding:"20px"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"20px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsx("span",{style:{fontSize:"24px"},children:a.icon}),e.jsx("h2",{style:{margin:0,color:"#fff"},children:a.title})]}),e.jsx("button",{onClick:i,style:{background:"#333",border:"none",borderRadius:"8px",color:"#fff",padding:"8px 16px",cursor:"pointer"},children:"✕ Close"})]}),e.jsx("div",{style:{flex:1,overflow:"auto",...ae,borderRadius:"12px",padding:"24px",whiteSpace:"pre-wrap",fontFamily:"monospace",fontSize:"14px",lineHeight:"1.6",color:"#ccc"},children:t||"Loading..."})]}),ka=({tier:a,price:t,monthlyPrice:i,annualPrice:s,billingPeriod:o,features:p,limits:h,scopes:x,isCurrentPlan:u,isPopular:c,onUpgrade:j,onManage:g})=>{const[y,F]=n.useState(!1),m=mn[a],v=o==="annual"?s:i;return e.jsxs("div",{onMouseEnter:()=>F(!0),onMouseLeave:()=>F(!1),style:{...ae,textAlign:"center",padding:"24px 20px",borderRadius:"16px",border:`1px solid ${m}40`,position:"relative",boxShadow:y?`0 0 40px ${m}40, 0 0 60px ${m}20`:`0 0 20px ${m}15`,transform:y?"scale(1.02)":"scale(1)",transition:"all 0.3s ease"},children:[c&&e.jsx("div",{style:{position:"absolute",top:"-12px",left:"50%",transform:"translateX(-50%)",background:`linear-gradient(135deg, ${m}, ${m}CC)`,color:a==="pro"?"#000":"#fff",fontSize:"10px",fontWeight:"700",padding:"6px 16px",borderRadius:"12px",boxShadow:`0 0 15px ${m}60`},children:"POPULAR"}),u&&e.jsx("div",{style:{position:"absolute",top:"-12px",right:"12px",background:"linear-gradient(135deg, #00D4FF, #0099CC)",color:"#fff",fontSize:"9px",fontWeight:"700",padding:"4px 10px",borderRadius:"8px",textTransform:"uppercase"},children:"Current Plan"}),e.jsx("div",{style:{fontSize:"22px",fontWeight:"700",color:m,marginTop:c?"8px":0},children:a.charAt(0).toUpperCase()+a.slice(1)}),e.jsxs("div",{style:{fontSize:"36px",fontWeight:"800",color:"#fff",margin:"12px 0 4px"},children:["$",v,e.jsx("span",{style:{fontSize:"14px",color:"#888",fontWeight:"400"},children:"/mo"})]}),o==="annual"&&a!=="free"&&e.jsxs("div",{style:{fontSize:"11px",color:m,marginBottom:"8px"},children:["$",v*12,"/year (billed annually)"]}),e.jsx("div",{style:{fontSize:"12px",color:"#888",marginBottom:"4px"},children:h}),e.jsx("div",{style:{fontSize:"11px",color:"#666",marginBottom:"12px"},children:p}),e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"4px",justifyContent:"center",marginTop:"12px",padding:"10px",background:"rgba(15, 15, 15, 0.6)",borderRadius:"8px"},children:x.map((f,D)=>e.jsx("span",{style:{fontSize:"9px",padding:"3px 6px",borderRadius:"4px",background:`${m}20`,color:m,border:`1px solid ${m}40`},children:f},D))}),e.jsx("div",{style:{marginTop:"16px"},children:u?a==="free"?e.jsx("div",{style:{padding:"10px 20px",background:"#333",borderRadius:"8px",color:"#888",fontSize:"12px"},children:"Current Plan"}):e.jsx("button",{onClick:g,style:{width:"100%",padding:"12px 20px",background:"transparent",border:`1px solid ${m}`,borderRadius:"8px",color:m,fontSize:"12px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s ease"},children:"Manage Subscription"}):e.jsx("button",{onClick:()=>j(a),style:{width:"100%",padding:"12px 20px",background:a==="free"?"#333":`linear-gradient(135deg, ${m}, ${m}CC)`,border:"none",borderRadius:"8px",color:a==="pro"?"#000":"#fff",fontSize:"12px",fontWeight:"700",cursor:a==="free"?"default":"pointer",boxShadow:a!=="free"?`0 0 15px ${m}40`:"none",transition:"all 0.2s ease"},children:a==="free"?"Free Forever":`Upgrade to ${a.charAt(0).toUpperCase()+a.slice(1)}`})})]})},kn=({environment:a})=>{const t=a==="live";return e.jsx("span",{style:{padding:"3px 8px",borderRadius:"4px",fontSize:"9px",fontWeight:"700",textTransform:"uppercase",letterSpacing:"0.5px",background:t?"rgba(57, 255, 20, 0.15)":"rgba(255, 184, 0, 0.15)",color:t?"#39FF14":"#FFB800",border:`1px solid ${t?"rgba(57, 255, 20, 0.4)":"rgba(255, 184, 0, 0.4)"}`},children:t?"LIVE":"TEST"})},Sn=({scope:a})=>{const i={"market:read":"#00D4FF","signals:read":"#39FF14","predictions:read":"#8B5CF6","accuracy:read":"#FFB800","strikeagent:read":"#FF6B35","webhooks:write":"#FF4444"}[a]||"#888";return e.jsx("span",{style:{padding:"2px 5px",borderRadius:"3px",fontSize:"8px",fontWeight:"600",background:`${i}15`,color:i,border:`1px solid ${i}30`},children:a})},Fn=({isOpen:a,title:t,message:i,onConfirm:s,onCancel:o})=>a?e.jsx("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.85)",zIndex:10001,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"},children:e.jsxs("div",{style:{...ae,borderRadius:"16px",padding:"24px",maxWidth:"400px",width:"100%",border:"1px solid #FF444440",boxShadow:"0 0 40px rgba(255, 68, 68, 0.2)"},children:[e.jsx("h3",{style:{margin:"0 0 12px",color:"#fff",fontSize:"18px"},children:t}),e.jsx("p",{style:{margin:"0 0 20px",color:"#888",fontSize:"14px",lineHeight:1.5},children:i}),e.jsxs("div",{style:{display:"flex",gap:"12px"},children:[e.jsx("button",{onClick:o,style:{flex:1,padding:"12px",background:"#333",border:"none",borderRadius:"8px",color:"#fff",fontSize:"13px",cursor:"pointer"},children:"Cancel"}),e.jsx("button",{onClick:s,style:{flex:1,padding:"12px",background:"linear-gradient(135deg, #FF4444, #FF6B6B)",border:"none",borderRadius:"8px",color:"#fff",fontSize:"13px",fontWeight:"600",cursor:"pointer"},children:"Regenerate"})]})]})}):null;function $n(){const[a,t]=n.useState("overview"),[i,s]=n.useState(!0),[o,p]=n.useState(0),[h,x]=n.useState(null),[u,c]=n.useState(()=>{const l=localStorage.getItem("adminTasks");return l?JSON.parse(l):hn}),[j,g]=n.useState(null),[y,F]=n.useState(""),[m,v]=n.useState([]),[f,D]=n.useState(!1),[L,X]=n.useState(""),[O,E]=n.useState("live"),[b,H]=n.useState(["market:read","signals:read"]),[I,Z]=n.useState(null),[Y,se]=n.useState({}),[U,le]=n.useState("monthly"),[te,ne]=n.useState("free"),[de,w]=n.useState(null);n.useEffect(()=>{localStorage.setItem("adminTasks",JSON.stringify(u))},[u]),n.useEffect(()=>{(async()=>{try{const[W,_]=await Promise.all([fetch("/api/analytics/dashboard?tenantId=pulse"),fetch("/api/analytics/live?tenantId=pulse")]),K=await W.json(),re=await _.json();x(K),p(re.liveVisitors||0)}catch(W){console.error("Failed to load analytics:",W)}finally{s(!1)}})();const C=setInterval(async()=>{try{const _=await(await fetch("/api/analytics/live?tenantId=pulse")).json();p(_.liveVisitors||0)}catch{}},3e4);return()=>clearInterval(C)},[]),n.useEffect(()=>{(async()=>{try{const C=JSON.parse(localStorage.getItem("userSession")||"{}"),W=C.sessionToken||C.token;if(!W)return;const K=await(await fetch("/api/developer/subscription",{headers:{"Content-Type":"application/json"},method:"POST",body:JSON.stringify({sessionToken:W})})).json();K.tier&&(ne(K.tier),H(Ee[K.tier]||Ee.free))}catch(C){console.error("Failed to fetch subscription:",C)}})()},[]);const z=async l=>{g(l),F("Loading...");try{const W=await(await fetch(l.file)).text();F(W)}catch{F("Failed to load document")}},q=l=>{c(C=>C.map(W=>W.id===l?{...W,done:!W.done}:W))},Q=u.filter(l=>l.done).length,R=Math.round(Q/u.length*100),B=h||{},G=[{id:"overview",label:"Overview",icon:"📊"},{id:"api",label:"API",icon:"🔑"},{id:"documents",label:"Documents",icon:"📁"},{id:"tasks",label:"Tasks",icon:"✅"},{id:"analytics",label:"Analytics",icon:"📈"}],$=async l=>{if(l!=="free")try{const C=JSON.parse(localStorage.getItem("userSession")||"{}"),W=C.id||C.email;if(!W){console.error("No user session found");return}let _;l==="enterprise"?_=U==="annual"?"/api/developer/billing/create-enterprise-annual":"/api/developer/billing/create-enterprise-monthly":_=U==="annual"?"/api/developer/billing/create-pro-annual":"/api/developer/billing/create-pro-monthly";const re=await(await fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:W})})).json();re.success&&re.url?window.location.href=re.url:console.error("Failed to create checkout session:",re.error)}catch(C){console.error("Upgrade error:",C)}},k=async()=>{try{const l=JSON.parse(localStorage.getItem("userSession")||"{}"),C=l.sessionToken||l.token,_=await(await fetch("/api/developer/billing/portal",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sessionToken:C})})).json();_.url&&(window.location.href=_.url)}catch(l){console.error("Failed to open billing portal:",l)}},P=async()=>{if(L.trim()){D(!0);try{const l=JSON.parse(localStorage.getItem("userSession")||"{}"),C=l.sessionToken||l.token;if(!C){console.error("No session token found - user not authenticated");return}const _=await(await fetch("/api/developer/keys",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sessionToken:C,name:L.trim(),environment:O,scopes:b})})).json();_.success?(Z({key:_.apiKey,keyId:_.keyId,prefix:_.prefix,name:L.trim(),environment:_.environment||O,scopes:_.scopes||b}),X(""),v(K=>[...K,{id:_.keyId,name:L.trim(),prefix:_.prefix,environment:_.environment||O,scopes:_.scopes||b,createdAt:new Date().toISOString(),status:"active"}])):_.error&&console.error("API key generation failed:",_.error)}catch(l){console.error("Failed to generate API key:",l)}finally{D(!1)}}},J=async l=>{try{const C=JSON.parse(localStorage.getItem("userSession")||"{}"),W=C.sessionToken||C.token,K=await(await fetch("/api/developer/keys/regenerate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({sessionToken:W,keyId:l})})).json();if(K.success){const re=m.find(me=>me.id===l);Z({key:K.apiKey,keyId:K.keyId,prefix:K.prefix,name:re?.name||"Regenerated Key",environment:re?.environment||"live",scopes:re?.scopes||b}),v(me=>me.map(ie=>ie.id===l?{...ie,prefix:K.prefix}:ie))}}catch(C){console.error("Failed to regenerate key:",C)}finally{w(null)}},d=(l,C)=>{navigator.clipboard.writeText(l),se(W=>({...W,[C]:!0})),setTimeout(()=>se(W=>({...W,[C]:!1})),2e3)};return e.jsxs("div",{style:{padding:"20px 0",paddingBottom:"100px"},children:[e.jsxs("div",{style:{marginBottom:"24px"},children:[e.jsx("h1",{style:{fontSize:"24px",fontWeight:"700",color:"#fff",margin:0},children:"🛠️ Developers Portal"}),e.jsx("p",{style:{color:"#888",margin:"8px 0 0",fontSize:"14px"},children:"Admin dashboard, business docs & analytics"})]}),e.jsx("div",{style:{display:"flex",gap:"8px",marginBottom:"24px",overflowX:"auto",paddingBottom:"8px"},children:G.map(l=>e.jsxs("button",{onClick:()=>t(l.id),style:{background:a===l.id?"linear-gradient(135deg, #00D4FF, #0099CC)":"rgba(26, 26, 26, 0.6)",backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",border:a===l.id?"none":"1px solid #2a2a2a",borderRadius:"8px",padding:"10px 16px",color:"#fff",cursor:"pointer",display:"flex",alignItems:"center",gap:"6px",whiteSpace:"nowrap",fontSize:"13px",fontWeight:a===l.id?"600":"400",transition:"all 0.2s ease"},children:[e.jsx("span",{children:l.icon}),l.label]},l.id))}),a==="overview"&&e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))",gap:"16px"},children:[e.jsx(dt,{count:o}),e.jsxs(Fe,{title:"Task Progress",icon:"📋",children:[e.jsxs("div",{style:{marginBottom:"12px"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"8px"},children:[e.jsxs("span",{style:{color:"#888",fontSize:"13px"},children:[Q," of ",u.length," tasks done"]}),e.jsxs("span",{style:{color:"#00D4FF",fontWeight:"600"},children:[R,"%"]})]}),e.jsx("div",{style:{height:"8px",background:"#2a2a2a",borderRadius:"4px",overflow:"hidden"},children:e.jsx("div",{style:{width:`${R}%`,height:"100%",background:"linear-gradient(90deg, #00D4FF, #39FF14)",borderRadius:"4px",transition:"width 0.3s ease"}})})]}),e.jsx("button",{onClick:()=>t("tasks"),style:{width:"100%",background:"rgba(42, 42, 42, 0.6)",border:"none",borderRadius:"8px",padding:"10px",color:"#fff",cursor:"pointer",fontSize:"13px"},children:"View All Tasks →"})]}),e.jsx(Fe,{title:"Quick Stats",icon:"⚡",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px"},children:[e.jsxs("div",{style:{textAlign:"center",padding:"12px",background:"rgba(15, 15, 15, 0.6)",borderRadius:"8px"},children:[e.jsx("div",{style:{fontSize:"24px",fontWeight:"700",color:"#00D4FF"},children:B.today?.views||0}),e.jsx("div",{style:{fontSize:"11px",color:"#666"},children:"Today"})]}),e.jsxs("div",{style:{textAlign:"center",padding:"12px",background:"rgba(15, 15, 15, 0.6)",borderRadius:"8px"},children:[e.jsx("div",{style:{fontSize:"24px",fontWeight:"700",color:"#39FF14"},children:B.allTime?.views||0}),e.jsx("div",{style:{fontSize:"11px",color:"#666"},children:"All Time"})]})]})}),e.jsx(Fe,{title:"Business Documents",icon:"📁",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[un.slice(0,3).map(l=>e.jsxs("div",{onClick:()=>z(l),style:{display:"flex",alignItems:"center",gap:"10px",padding:"10px",background:"rgba(15, 15, 15, 0.6)",borderRadius:"8px",cursor:"pointer"},children:[e.jsx("span",{children:l.icon}),e.jsx("span",{style:{color:"#ccc",fontSize:"13px"},children:l.title})]},l.id)),e.jsx("button",{onClick:()=>t("documents"),style:{background:"rgba(42, 42, 42, 0.6)",border:"none",borderRadius:"8px",padding:"10px",color:"#fff",cursor:"pointer",fontSize:"13px"},children:"View All Docs →"})]})})]}),a==="api"&&e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(12, 1fr)",gap:"16px"},children:[e.jsxs("div",{style:{gridColumn:"1 / -1",...ae,borderRadius:"20px",padding:"28px",border:"1px solid rgba(0, 212, 255, 0.3)",boxShadow:"0 0 50px rgba(0, 212, 255, 0.15)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"16px",marginBottom:"20px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"14px"},children:[e.jsx("span",{style:{fontSize:"28px"},children:"🚀"}),e.jsxs("div",{children:[e.jsx("h3",{style:{margin:0,color:"#fff",fontSize:"20px",fontWeight:"700"},children:"Pulse Developer API"}),e.jsx("p",{style:{margin:"4px 0 0",color:"#888",fontSize:"13px"},children:"Access AI signals, market data & safety scanning"})]})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsxs("div",{style:{display:"flex",background:"rgba(15, 15, 15, 0.6)",borderRadius:"10px",padding:"4px",border:"1px solid #333"},children:[e.jsx("button",{onClick:()=>le("monthly"),style:{background:U==="monthly"?"linear-gradient(135deg, #00D4FF, #0099CC)":"transparent",border:"none",borderRadius:"8px",padding:"10px 18px",color:U==="monthly"?"#fff":"#888",cursor:"pointer",fontWeight:"600",fontSize:"12px",transition:"all 0.2s ease"},children:"Monthly"}),e.jsx("button",{onClick:()=>le("annual"),style:{background:U==="annual"?"linear-gradient(135deg, #39FF14, #2ECC71)":"transparent",border:"none",borderRadius:"8px",padding:"10px 18px",color:U==="annual"?"#000":"#888",cursor:"pointer",fontWeight:"600",fontSize:"12px",transition:"all 0.2s ease"},children:"Annual"})]}),U==="annual"&&e.jsx("span",{style:{background:"linear-gradient(135deg, #39FF14, #2ECC71)",color:"#000",fontSize:"10px",fontWeight:"700",padding:"6px 12px",borderRadius:"12px",boxShadow:"0 0 10px rgba(57, 255, 20, 0.4)"},children:"~17% savings"})]})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(240px, 1fr))",gap:"20px",marginTop:"20px"},children:[e.jsx(ka,{tier:"free",monthlyPrice:0,annualPrice:0,billingPeriod:U,limits:"60 req/min • 2K/day",features:"Market Data + Signals",scopes:Ee.free,isCurrentPlan:te==="free",onUpgrade:$,onManage:k}),e.jsx(ka,{tier:"pro",monthlyPrice:29,annualPrice:24,billingPeriod:U,limits:"600 req/min • 100K/day",features:"+ Predictions + Accuracy",scopes:Ee.pro,isCurrentPlan:te==="pro",isPopular:!0,onUpgrade:$,onManage:k}),e.jsx(ka,{tier:"enterprise",monthlyPrice:99,annualPrice:82,billingPeriod:U,limits:"3000 req/min • 1M/day",features:"+ StrikeAgent + Webhooks",scopes:Ee.enterprise,isCurrentPlan:te==="enterprise",onUpgrade:$,onManage:k})]})]}),e.jsxs("div",{style:{gridColumn:"span 12",display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(320px, 1fr))",gap:"16px"},children:[e.jsxs(Fe,{title:"Generate API Key",icon:"🔐",glowColor:"#00D4FF",children:[e.jsxs("div",{style:{display:"flex",gap:"12px",marginBottom:"12px",flexWrap:"wrap"},children:[e.jsx("input",{type:"text",value:L,onChange:l=>X(l.target.value),placeholder:"Key name (e.g., My Trading Bot)",style:{flex:1,minWidth:"200px",background:"rgba(15, 15, 15, 0.6)",border:"1px solid #333",borderRadius:"8px",padding:"12px",color:"#fff",fontSize:"14px"}}),e.jsxs("div",{style:{display:"flex",gap:"4px",background:"rgba(15, 15, 15, 0.6)",borderRadius:"8px",padding:"4px",border:"1px solid #333"},children:[e.jsx("button",{onClick:()=>E("live"),style:{background:O==="live"?"linear-gradient(135deg, #39FF14, #2ECC71)":"transparent",border:"none",borderRadius:"6px",padding:"8px 14px",color:O==="live"?"#000":"#888",cursor:"pointer",fontWeight:"600",fontSize:"12px"},children:"Live"}),e.jsx("button",{onClick:()=>E("test"),style:{background:O==="test"?"linear-gradient(135deg, #FFB800, #FF8C00)":"transparent",border:"none",borderRadius:"6px",padding:"8px 14px",color:O==="test"?"#000":"#888",cursor:"pointer",fontWeight:"600",fontSize:"12px"},children:"Test"})]}),e.jsx("button",{onClick:P,disabled:f||!L.trim(),style:{background:f?"#333":"linear-gradient(135deg, #00D4FF, #0099CC)",border:"none",borderRadius:"8px",padding:"12px 20px",color:"#fff",cursor:f?"wait":"pointer",fontWeight:"600",opacity:L.trim()?1:.5,boxShadow:!f&&L.trim()?"0 0 15px rgba(0, 212, 255, 0.3)":"none"},children:f?"Generating...":"Generate Key"})]}),e.jsx("div",{style:{fontSize:"11px",color:"#666",marginBottom:"12px"},children:O==="live"?"🟢 Live keys access real data and count against rate limits":"🟡 Test keys return mock data for development - no rate limit impact"}),I&&e.jsxs("div",{style:{background:"rgba(10, 26, 10, 0.6)",border:"2px solid #39FF14",borderRadius:"12px",padding:"20px",marginTop:"16px",boxShadow:"0 0 30px rgba(57, 255, 20, 0.3), inset 0 0 20px rgba(57, 255, 20, 0.05)",animation:"glowPulse 2s ease-in-out infinite"},children:[e.jsx("style",{children:`
                    @keyframes glowPulse {
